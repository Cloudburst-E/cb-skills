...
- Update existing references across `skills/cloudburst-agent`, `skills/cb-product-agent`, `skills/cb-engineering-agent`, or `skills/cb-ops-agent` (and create new ones when gaps appear).

...
- Maintain the roadmap, release notes, and product requirement docs stored under `frontend/docs/` or `cb-skills/skills/cloudburst-agent/references/`.
...
- Update or add references under `skills/cloudburst-agent/references/` for new UX heuristics, Figma workflows, or product rituals.
